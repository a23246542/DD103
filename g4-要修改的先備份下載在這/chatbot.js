...
function chatBotScrollTo(container, content) {
    ...
    //  content_h = content.scrollHeight,
    ...
    //      top:h,
    //  })
    // content_h.scrollTop=h;
    // container_h.scrollTop=h;
    // $("#chatBot-content").animate({scrollTop:0},400);
    // content_h.scrollTop=h;

//    var content_h = $('#chatBot-content').Height,
//      container_h = $('#chatBot-box').Height;
//    var content_h = document.getElementById("chatBot-content").Height,
//      container_h = document.getElementById("chatBot-box").Height;
