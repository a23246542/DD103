        ...
        --  `actTotal`, 
         `actContent`,
          ...
          `actTime`,
           ...
           `actCancelStat`,
           `actPic`)
            VALUES (:typeNo,:memNo,:actName,:actLoc,:actZone,:actStren,:actLimit,:actContent,:actStartDate,:actTime,NULL,NULL,:actDeadLine,'0',:actPic)";
